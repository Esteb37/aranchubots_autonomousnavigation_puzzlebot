...
class PuzzlebotLocClass():
	def __init__(self):
		...
		odom_marker_pub = rospy.Publisher('/odom_marker', Marker, queue_size=1)
		...
		while not rospy.is_shutdown():
			...
			odom_marker = Marker()
			odom_marker.header.frame_id = "base_link"
			odom_marker.header.stamp = rospy.Time.now()
			odom_marker.ns = "odom_marker"
			odom_marker.id = 0
			odom_marker.type = Marker.CUBE
			odom_marker.action = Marker.ADD
			odom_marker.pose.position.x = 0
			odom_marker.pose.position.y = 0
			odom_marker.pose.position.z = 0
			odom_marker.pose.orientation.x = 0.0
			odom_marker.pose.orientation.y = 0.0
			odom_marker.pose.orientation.z = 0.0
			odom_marker.pose.orientation.w = 1.0
			odom_marker.scale.x = self.L
			odom_marker.scale.y = self.L
			odom_marker.scale.z = 0.1
			odom_marker.color.a = 1.0
			odom_marker.color.r = 1.0
			odom_marker.color.g = 0.0
			odom_marker.color.b = 0.0

			odom_marker_pub.publish(odom_marker)
